export class Alert {
    ...
    public static getData() {
        return [
            ...
            new Alert(50,  'Failed Login',                       '125', '2 hours ago',  'Snort',      '10.23.41.123', 'Los Angeles, CA USA',      '10.23.41.123', 'x230-32122',     'New'),
            ...
            new Alert(40,  'Failed Login',                       '113', '8 hours ago',  'Fire Eye',   '10.23.41.123', 'Limerick, Ireland',        '10.23.41.123', 'ww-staff-wp1',   'New'),
            new Alert(34,  'Anomaly - Port scan',                '117', '7 hours ago',  'Metron',     '10.23.41.123', 'Los Angeles, CA USA',      '10.23.41.123', 'x230-34432',     'New')
        ];
    }
}